...
import com.mytravelstatus.app.data.models.LocationReading
import com.mytravelstatus.app.data.models.LocationSource
...
class LocationWorker(
    ...
    private val repository = MyTravelStatusApp.instance.repository
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            val isSchengen = countryCode?.let { TravelStatusCountries.isSchengen(it) } ?: false
