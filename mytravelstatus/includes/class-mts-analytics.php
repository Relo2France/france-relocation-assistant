...
class MTS_Analytics {
	...
	private function __construct() {
		...
		add_action( 'mts_daily_cron', array( $this, 'record_daily_snapshot' ) );
	}
	...
	public function get_compliance_history( $request ) {
		...
		$table            = MTS_Schema::get_table( 'analytics_snapshots' );
	...
	public function record_daily_snapshot() {
		...
		$analytics_table = MTS_Schema::get_table( 'analytics_snapshots' );
		$family_table    = MTS_Schema::get_table( 'family_members' );
	...
	private function calculate_member_compliance( $user_id, $member_id ) {
		...
		$trips_table     = MTS_Schema::get_table( 'trips' );
		$travelers_table = MTS_Schema::get_table( 'trip_travelers' );
