<?php
/**
 * Premium feature gating for MyTravelStatus.
 *
...
class MTS_Premium {
	 ...
	 * @var string
	 */
	const USER_META_KEY = 'mts_enabled';
	 ...
	 * @var string
	 */
	const GLOBAL_OPTION = 'mts_global_enabled';
	 ...
	 * @var string
	 */
	const UPGRADE_URL_OPTION = 'mts_upgrade_url';
	...
	/**
	 * Check if the MyTravelStatus feature is enabled for a user.
	 *
	 * Priority:
	 * 1. User meta override (admin can enable/disable per user)
	...
	public function is_feature_enabled( $user_id = 0 ) {
		...
		$filtered = apply_filters( 'mts_premium_check', null, $user_id );
		if ( null !== $filtered ) {
	...
	public function get_upgrade_url() {
		...
		$url = apply_filters( 'mts_upgrade_url', null );
	...
	public function get_upgrade_message() {
		return apply_filters(
			'mts_upgrade_message',
			__( 'MyTravelStatus is a premium feature. Upgrade to access full functionality.', 'mytravelstatus' )
		);
	}
