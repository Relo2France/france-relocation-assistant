    ...
    */
    ...
    private function enqueue_shortcode_assets() {
        ...
        wp_localize_script('fra-frontend-script', 'fraData', array(
            ...
            // wp_logout_url() returns an HTML-escaped URL (&amp;); JS navigates to it, so unescape.
            'logoutUrl' => str_replace('&amp;', '&', wp_logout_url(home_url('/portal/?signed_out=1'))),
...
require_once FRA_PLUGIN_DIR . 'includes/class-fra-site-admin-guide.php';
...
// Launch validation removed - no longer needed after launch
