 ...
 * Markdown Message
 *
 * Renders the markdown the model returns for AI answers. Shared by the guide
 * assistant and the knowledge base chat, which each carried their own
 * near-duplicate renderer. They had drifted apart: one handled "#" but not
 * "---", the other the reverse, and neither did italics - so the same answer
 * rendered differently depending on which screen you were on.
 *
