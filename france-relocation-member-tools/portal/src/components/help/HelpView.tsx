...
const PARTS: { title: string; body: string; view: string; label: string }[] = [
  ...
  { title: 'Family', body: 'One file per person. Add your partner and children, hand steps to your partner, or give them their own sign-in to complete their part. Their steps sit on the same calendar as yours.', view: 'family', label: 'Open' },
...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: 'Why are some steps in my file marked for my partner?', a: 'Each adult applies separately and the partner\'s documents are theirs. Steps carry a person; the filter chips on each stage show yours, theirs, or the children\'s. Hand a step over from the Family page.' },
