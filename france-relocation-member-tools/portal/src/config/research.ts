 ...
 * Based on relo2france france-overview.jsx template
 */
export const REPORT_SECTIONS = {
  region: [
    { id: 'geography', title: 'Geography & Landscape', icon: '🗺️' },
    { id: 'climate', title: 'Climate', icon: '🌡️' },
    { id: 'demographics', title: 'Demographics & Population', icon: '👥' },
    { id: 'economy', title: 'Economy', icon: '📈' },
    { id: 'language', title: 'Language & Communication', icon: '💬' },
    { id: 'food_wine', title: 'Food & Wine Culture', icon: '🍷' },
    { id: 'culture_lifestyle', title: 'Culture & Lifestyle', icon: '🎭' },
    { id: 'subdivisions', title: 'Departments & Key Areas', icon: '🏛️' },
    { id: 'quality_of_life', title: 'Quality of Life', icon: '❤️' },
    { id: 'transportation', title: 'Transportation', icon: '🚆' },
    { id: 'environment', title: 'Environment & Natural Heritage', icon: '🌲' },
  ],
  department: [
    { id: 'geography', title: 'Geography & Landscape', icon: '🗺️' },
    { id: 'climate', title: 'Climate', icon: '🌡️' },
    ...
    { id: 'transportation', title: 'Transportation', icon: '🚆' },
    { id: 'environment', title: 'Environment & Natural Heritage', icon: '🌲' },
    { id: 'practical_info', title: 'Practical Information', icon: 'ℹ️' },
  ],
  commune: [
    { id: 'geography', title: 'Geography & Landscape', icon: '🗺️' },
    { id: 'climate', title: 'Climate', icon: '🌡️' },
    ...
    { id: 'environment', title: 'Environment & Natural Heritage', icon: '🌲' },
    { id: 'practical_info', title: 'Practical Information', icon: 'ℹ️' },
    { id: 'local_life', title: 'Local Life & Community', icon: '🏘️' },
  ],
};
