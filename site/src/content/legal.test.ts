...
describe('legal pages', () => {
  ...
  it('carry a date and describe the service as it runs', () => {
    ...
    for (const fact of ['WordPress.com', 'Cloudflare', 'Stripe', 'MemberPress', 'Anthropic', 'passport numbers', 'Settings', 'not affiliated with the French government', '30-day money-back guarantee']) {
