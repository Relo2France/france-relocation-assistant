...
export const coverage: CoverageArea[] = [
  { name: 'Visas', topics: 12, examples: 'Visitor, work, talent passport, student, entrepreneur, spouse' },
  ...
  { name: 'Tax', topics: 8, examples: 'Residency, the treaty, retirement income, first return' },
  ...
  { name: 'Settling in', topics: 2, examples: 'Registration, utilities, schools' },
];
